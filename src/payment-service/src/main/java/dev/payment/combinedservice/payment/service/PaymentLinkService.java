...
import dev.payment.combinedservice.payment.dto.response.PaymentLinkResponse;
import dev.payment.combinedservice.payment.exception.ApiException;
import dev.payment.combinedservice.payment.repository.PaymentLinkRepository;
...
public class PaymentLinkService {
    ...
    public PaymentLinkResponse markAsPaid(String referenceId, UUID paymentId) {
        ...
        paymentLink.setStatus(dev.payment.combinedservice.payment.domain.enums.PaymentStatus.CAPTURED);
