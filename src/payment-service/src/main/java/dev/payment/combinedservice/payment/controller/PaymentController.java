...
import dev.payment.combinedservice.payment.dto.request.CardTokenizationRequest;
import dev.payment.combinedservice.payment.dto.request.CreatePaymentLinkRequest;
import dev.payment.combinedservice.payment.dto.request.CreatePaymentRequest;
import dev.payment.combinedservice.payment.dto.request.CreateRefundRequest;
import dev.payment.combinedservice.payment.dto.request.InitiatePaymentRequest;
import dev.payment.combinedservice.payment.dto.response.*;
...
import dev.payment.combinedservice.payment.service.LedgerService;
import dev.payment.combinedservice.payment.service.PaymentAnalyticsService;
import dev.payment.combinedservice.payment.service.PaymentLinkService;
import dev.payment.combinedservice.payment.service.PaymentQueryService;
import dev.payment.combinedservice.payment.service.PaymentService;
...
@PostMapping("/initiate")
    public ApiResponse<InitiatePaymentResponse> initiatePayment(
        ...
        CreatePaymentRequest createRequest = new CreatePaymentRequest(
                orderId,
                merchantId,
                dev.payment.combinedservice.payment.domain.enums.PaymentMethod.CARD,
                "RAZORPAY_SIMULATOR",
                dev.payment.combinedservice.payment.domain.enums.TransactionMode.TEST,
