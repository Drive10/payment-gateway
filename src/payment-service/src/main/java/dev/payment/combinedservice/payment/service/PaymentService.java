...
import dev.payment.combinedservice.payment.dto.response.CardTokenizationResponse;
import dev.payment.combinedservice.payment.dto.response.RefundResponse;
...
import dev.payment.combinedservice.payment.integration.processor.PaymentProcessorCaptureResponse;
import dev.payment.combinedservice.payment.integration.processor.PaymentProcessorClient;
import dev.payment.combinedservice.payment.integration.processor.PaymentProcessorIntentResponse;
import dev.payment.combinedservice.payment.mapper.PaymentMapper;
...
import dev.payment.combinedservice.payment.service.bin.CardBinService;
...
private String resolveSimulationMode(Payment payment) {
    ...
    public CardTokenizationResponse tokenizeCard(dev.payment.combinedservice.payment.dto.request.CardTokenizationRequest request) {
