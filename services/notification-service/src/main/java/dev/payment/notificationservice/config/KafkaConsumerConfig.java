package dev.payment.notificationservice.config;
...
public class KafkaConsumerConfig {
    ...
    CommonErrorHandler kafkaErrorHandler(
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(recoverer, new FixedBackOff(retryBackoffMs, Math.max(0, retryAttempts - 1)));
