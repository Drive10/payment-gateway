...
import { Search, Filter, Download, ChevronLeft, ChevronRight, ShoppingCart } from 'lucide-react'
...
export function AdminOrders() {
  ...
  const handleExportCSV = () => {
    const headers = ['ID', 'Order Reference', 'User', 'Amount', 'Currency', 'Status', 'Date']
