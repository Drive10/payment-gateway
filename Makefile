.PHONY: bootstrap doctor smoke test-all up up-full up-hybrid down test build verify compose-check frontend-check payment-local
...
test-all:
	powershell -ExecutionPolicy Bypass -File ./scripts/dev.ps1 test-all
